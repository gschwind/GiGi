...
#ifndef _GG_SDL2GUI_h_
#define _GG_SDL2GUI_h_
...
#ifdef _MSC_VER
# ifdef GiGiSDL2_EXPORTS
#  define GG_SDL2_API __declspec(dllexport)
# else
#  define GG_SDL2_API __declspec(dllimport)
# endif
#else
# define GG_SDL2_API
#endif
...
class GG_SDL2_API SDL2GUI : public GG::GUI
{
public:
    /** \name Structors */ ///@{
    explicit SDL2GUI(int w = 1024, int h = 768, bool calc_FPS = false, const std::string& app_name = "GG"); ///< ctor
    virtual ~SDL2GUI();
    //@}
